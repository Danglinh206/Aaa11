...
app.get('/ramdontt/vdcosplay', async (req, res) => {
  try {
    const edits = ["@iconsrikka","@smiley_cosplay_26th1","@i_am_ngvtien06","@pmaosensei","@ngancosplay_204","@nnnnaa1","@anlmecos","@ninokawaiii","@ssarahh1311","@etamecosplay26","@dumbapples0","@ruuent","@maixphat","@etamecosplay26","@fuyuka05.7","@lovewaifu2345","@maixphat","@pmaosensei","@ninokawaiii"];
